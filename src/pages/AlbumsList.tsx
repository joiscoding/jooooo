  ...
  return (
    <div className="page-narrow albums-page">
      ...
      {albums.length === 0 ? (
        <ListEmptyState
          title="No albums yet"
          description="Use the form above to create your first album, or save a look from the gallery to start a collection."
        >
          <a className="btn primary" href="#create-album">
            Create an album
          </a>
