  ...
  return (
    <div className="page-narrow albums-page">
      ...
      {albums.length === 0 ? (
        <ListEmptyState
          title="No albums yet"
          description="Save curated looks into albums. Name your first album above, or browse the gallery and add looks from any look page."
          primary={{
          ...
          secondary={{ label: 'Browse gallery', to: '/' }}
        />
      ) : (
