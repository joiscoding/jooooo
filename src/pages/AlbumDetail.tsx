    ...
    <div className="album-detail-page">
      ...
      {album.lookIds.length === 0 ? (
        <ListEmptyState
          ...
          description="Save looks from the gallery or from any look page while you browse."
          primaryAction={{ action: 'route', label: 'Browse gallery', to: '/' }}
          secondaryAction={{ action: 'route', label: 'Back to albums', to: '/albums' }}
        />
      ) : (
