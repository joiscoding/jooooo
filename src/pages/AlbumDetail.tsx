    ...
    <div className="album-detail-page">
      ...
      {album.lookIds.length === 0 ? (
        <ListEmptyState
          ...
          description="Save looks from the gallery or from any look detail page to fill this album."
          primaryAction={{ label: 'Browse looks', to: '/' }}
          secondaryAction={{ label: 'All albums', to: '/albums' }}
        />
      ) : (
