    ...
    <div className="album-detail-page">
      ...
      {album.lookIds.length === 0 ? (
        <ListEmptyState
          ...
          description="Browse the gallery or open any look and use “Add to album” to save pieces here."
          primary={{ kind: 'link', to: '/', label: 'Browse looks' }}
          secondary={{ kind: 'link', to: '/albums', label: 'All albums' }}
        />
      ) : (
