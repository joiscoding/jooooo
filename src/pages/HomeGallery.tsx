      ...
      {filtered.length === 0 ? (
        looks.length === 0 ? (
          <ListEmptyState
            ...
            description="Looks from the catalog will appear here. If you load looks from another source, refresh once data is ready."
            primary={{ label: 'Go to albums', to: '/albums' }}
            secondary={{
          ...
          <ListEmptyState
            ...
            description="Try another style, or show the full gallery."
            primary={{
