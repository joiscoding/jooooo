...
function lookMatchesSearch(look: Look, raw: string): boolean {
...
export function HomeGallery() {
  ...
  const filtered = useMemo(() => {
    ...
    return byTag.filter((l) => lookMatchesSearch(l, query));
  }, [looks, filter, query]);

  const byTagOnly = useMemo(() => {
